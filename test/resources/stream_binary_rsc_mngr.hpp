...
template<> struct std::hash<stream_binary_rsc_mngr>
{
    std::size_t operator()(stream_binary_rsc_mngr const& value) const noexcept { return std::hash<std::string>{}(value.contents); }
};
...
template<> struct std::hash<throw_stream_binary_rsc_mngr>
{
    std::size_t operator()(throw_stream_binary_rsc_mngr const& value) const noexcept { return std::hash<std::string>{}(value.contents); }
};
