...
class ArbaRsceRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "rsce"
    name = f"{project_namespace}-{project_base_name}"
    package_type = "library"

    # Optional metadata
    description = "A C++ library providing tools for managing resources."
    url = "https://github.com/arapelle/arba-rsce"
    homepage = "https://github.com/arapelle/arba-rsce"
    topics = ("resource", "resource-manager")
    license = "MIT"
